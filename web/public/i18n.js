...
const I18N = {
  ko: {
    ...
    collectionTitle: '수집함',
    collectionLead: '지금까지 딴 것 중 희귀한 것들이에요.',
    ...
    legendTitle: '등급 기준',
    trophyShelf: '트로피',
    trophyShelfLead: '가장 희귀한 것부터 · 좌우로 넘겨보세요',
    gameShelf: '게임별 수집 현황',
    gameShelfLead: '전설을 많이 딴 게임부터',
  ...
  en: {
    ...
    collectionTitle: 'Trophy case',
    collectionLead: 'The rarest things you have unlocked so far.',
    ...
    trophyShelfLead: 'Rarest first · scroll sideways',
    gameShelf: 'By game',
    gameShelfLead: 'Games where you earned the most legendaries',
    gameShelfEmpty: 'No achievements unlocked yet.',
    crownBadge: 'Personal best',
